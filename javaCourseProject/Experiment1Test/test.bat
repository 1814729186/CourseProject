@echo off
rem set JAVA_HOME=D:\jdk-13.0.2-64bit
set JAVA_HOME=C:\Users\MaZhongping\.jdks\adopt-openjdk-13.0.2\bin
...
set TO_BE_TEST_CLASSPAH=G:\Daily_Files\Study_Files\gitFolder\CourseProject\javaCourseProject\SearchEngine\bin\production\SearchEngineForStudent
rem set TO_BE_TEST_CLASSPAH=.\betest
